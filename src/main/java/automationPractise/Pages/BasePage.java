...
public class BasePage {
    ...
    public static String gridURL="https://shwetabuchha6:2c80b457-e4f0-4e3f-afa7-ecbeccad12e5@ondemand.us-west-1.saucelabs.com:443/wd/hub";
    ...
    public void openBrowser(String browserName, String url) throws MalformedURLException {
        if(browserName.equalsIgnoreCase("chrome")) {
            ...
            browserOptions.setCapability("browserVersion", "70");
            browserOptions.setCapability("sauce:options", sauceOptions);
            browserOptions.setCapability("idleTimeout","180" );
            try {
